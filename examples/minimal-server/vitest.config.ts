...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@third-eye-cyborg/ascended-privacy": fileURLToPath(new URL("../../packages/privacy/src/index.ts", import.meta.url)),
      "@third-eye-cyborg/ascended-ai-router": fileURLToPath(new URL("../../packages/ai-router/src/index.ts", import.meta.url)),
