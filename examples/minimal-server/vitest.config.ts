...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@third-eye-cyborg/privacy": fileURLToPath(new URL("../../packages/privacy/src/index.ts", import.meta.url)),
      "@third-eye-cyborg/ai-router": fileURLToPath(new URL("../../packages/ai-router/src/index.ts", import.meta.url)),
